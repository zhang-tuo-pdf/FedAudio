for i in {1..10}
    ...
    echo "taskset 100 python3 urbansound_loader.py --raw_data_path /media/data/public-data/SoundEvent/UrbanSound8K/ --output_data_path /media/data/projects/speech-privacy/fedspeech/data/urban_sound --setup centralized --fl_feature False --alpha 1.0 --test_fold" $i
    taskset 100 python3 urbansound_loader.py --raw_data_path /media/data/public-data/SoundEvent/UrbanSound8K/ --output_data_path /media/data/projects/speech-privacy/fedspeech/data/urban_sound --setup centralized --fl_feature False --alpha 1.0 --test_fold $i
done
