...
from data_split.meld_split import audio_partition
...
def load_partition_data_audio(
    ...
    # test dataset
    wav_global_test, class_num = audio_partition(folder_path, split='test')
    # step 2 preprocess data
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--raw_data_path', type=str, default='../../data/meld', help='Raw data path of MELD data set'
    )
    ...
    parser.add_argument(
        '--test_fold', type=int, default=1, help='Test fold id for MELD dataset, default test fold is 1'
    )
